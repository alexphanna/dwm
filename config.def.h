...
static const char *fonts[]          = { "SF Mono:style=semibold:size=10", "Material Icons Round:size=10" };
...
static const Rule rules[] = {
	...
	{ "st",    	  NULL,    	 NULL,         				  0,        0,           1,          0,       	  -1,		 0,0,0,0,				  0 },
 	{ "firefox",  NULL,      "Picture-in-Picture",       ~0,		1,			-1,      	 0,           -1,        1424,794,480,270,        0 },
 	{ "mpv",  	  NULL,      NULL,      				 ~0,		1,			-1,      	 0,           -1,        1424,794,480,270,        0 },
};
